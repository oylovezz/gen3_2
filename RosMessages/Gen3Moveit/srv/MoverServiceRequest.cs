...
namespace RosMessageTypes.Gen3Moveit
{
    public class MoverServiceRequest : Message
    {
        ...
        public Gen3MoveitJoints joints_input;
        public Geometry.Pose pick_pose;
        public Geometry.Pose place_pose;

        public MoverServiceRequest()
        {
            this.joints_input = new Gen3MoveitJoints();
            this.pick_pose = new Geometry.Pose();
            this.place_pose = new Geometry.Pose();
        }

        public MoverServiceRequest(Gen3MoveitJoints joints_input, Geometry.Pose pick_pose, Geometry.Pose place_pose)
        {
