...
{
    public class Gen3MoveitJoints : Message
    {
        public const string RosMessageName = "gen3_moveit/Gen3MoveitJoints";
        ...
        public Gen3MoveitJoints(double joint_00, double joint_01, double joint_02, double joint_03, double joint_04, double joint_05, double joint_06, Geometry.Pose pick_pose, Geometry.Pose place_pose)
        {
