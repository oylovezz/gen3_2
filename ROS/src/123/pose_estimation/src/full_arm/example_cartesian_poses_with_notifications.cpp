...
bool example_cartesian_action(ros::NodeHandle n, const std::string &robot_name)
{
  ...
  my_constrained_pose.target_pose.x = -0.874f;
  my_constrained_pose.target_pose.y = -0.181f;
  my_constrained_pose.target_pose.z = -0.450f;
  my_constrained_pose.target_pose.theta_x = 0.0f;
  my_constrained_pose.target_pose.theta_y = 0.0f;
  my_constrained_pose.target_pose.theta_z = 0.0f;
